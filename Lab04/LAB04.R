...
setwd("your working directory/LAB04")
## Data about teens is in student table on the database. So lets log into the database and see the structure. 
library(RPostgreSQL)
conn<-dbConnect("PostgreSQL",dbname="infs494",host="147.126.64.66", port=8432, user="dataminer45", password="spring2019")
...
##Doesn't age depends upon grad years?q  So I should calculate average age by grad year and use that 
